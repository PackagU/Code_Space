...
| 04 동적 장애물 | `[85%]` | 2026-08-18: 보행자 활성 왕복 체인 10/10 연속 검증 + 근접 일시정지 모델(관통 전복 차단). 남은 것: collision_monitor 도입 검토 |
| 05 엘베 내부 + 멀티층 | `[70%]` | 2026-08-18: **F2→F1 역방향 전환(WITH_RETURN) 구현·검증** — 왕복 배달 체인 완성. 엘베 칸 내부 모델링/도킹 정밀도 미완 |
| 06 통합 반복 안정성 | `[90%]` | 2026-08-18: **왕복 체인(보행자+팔 mock) 데스크톱 10/10 연속 PASS** (`run_roundtrip_repeat.sh`, OOM 0·메모리 안정). 이 과정에서 산발 결함 4종 근절(§1.25). 남은 것: 고장 주입 5종 완결 |
| 07 Jetson 배포 | `[75%]` | 2026-08-18: **분산 왕복 3/3 완주** (mock 팔, cpu_peak 67~87%/600%, mem 2.4~2.8GB) + compose 장치 env 화(HW 미장착 기동 가능). 남은 것: 실기 센서(RPLiDAR) 주행, missed-rate 실기 임계 수립 |
