...
# 처음에는 모두 1500 근처, 한 관절씩 실측 조정 (Kim)
POSES = {
...
def pose_command(pose_name, duration_ms):
    """네 모터 동시 이동 명령 문자열. PWM 안전 범위·이동 시간 검증 포함."""
...
def interpolate_pwm(elapsed_ms, cycle=PRESS_CYCLE, start_pose="home"):
